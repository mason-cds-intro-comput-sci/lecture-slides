...
The `qplot()` function is part of the `ggplot2` package.

**Packages** are a way of using code written by somebody else.

We need to load the `ggplot2` package before we can use any of the functions that it contains.
...
Then we can use the `qplot()` function to create a graph.
